...
inc_dirs = [
    "include","/usr/local/Cellar/glew/2.2.0_1/include/", "/usr/local/Cellar/glm/0.9.9.8/include/","/usr/local/Cellar/libpng/1.6.40/include/"," /usr/local/Cellar/freetype/2.13.2/include/","/usr/local/Cellar/freetype/2.13.2/include/freetype2/"
]
